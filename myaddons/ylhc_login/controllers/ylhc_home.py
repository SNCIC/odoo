...
class AdminHome(Home):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        login_style = ir_config.get_param(
            key='ylhc_theme_settting.login_style', default='login_style1')
        login_template = 'ylhc_login.{login_style}'.format(login_style=login_style)
        
        # add extra info to login page
        values['title'] = ir_config.get_param(
            "ylhc_theme_setting.window_default_title", "OpenErpNext")
